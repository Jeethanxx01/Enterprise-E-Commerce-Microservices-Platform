...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'fontSize': '16px', 'fontFamily': 'arial', 'primaryColor': '#2c3e50', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#2c3e50', 'lineColor': '#2c3e50', 'secondaryColor': '#34495e', 'tertiaryColor': '#95a5a6'}}}%%
sequenceDiagram
    participant User
